        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-8">
            {projects.map((p) => (
              <Card
                key={p.title}
                className="card-gradient overflow-hidden border-border/60 hover:border-primary/50 hover:shadow-elegant transition-smooth group"
              >
                <div className="grid md:grid-cols-5 gap-0">
                  <div className="md:col-span-2 relative bg-gradient-to-br from-primary/10 via-accent/5 to-transparent p-10 flex items-center justify-center min-h-[260px]">
                    <div className="relative">
                      <div className="absolute inset-0 bg-primary/30 blur-3xl rounded-full animate-glow-pulse" />
                      <div className="relative p-6 rounded-2xl bg-background/40 backdrop-blur-sm border border-border/60 group-hover:scale-110 group-hover:rotate-3 transition-smooth">
                  ...
                  <div className="md:col-span-3 p-8 space-y-5">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {p.stack.map((t) => (
                        <span key={t} className="px-2.5 py-0.5 text-xs font-mono rounded bg-secondary text-secondary-foreground">
                          {t}
                        </span>
                      ))}
                    </div>
